import { sleep, keyboard, Key, mouse, screen, straightTo, Point } from "@nut-tree/nut-js";
...
async function 풍년가() {
  await keyboard.pressKey(Key.Num3);
  await keyboard.releaseKey(Key.Num3);
...
export async function 물(cnt = Infinity, bottleChangeCount = 80) {
  let count = 0;
