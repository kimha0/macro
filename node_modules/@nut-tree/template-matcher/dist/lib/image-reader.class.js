    ...
    async load(path) {
        return new Promise(async (resolve, reject) => {
            try {
                ...
                resolve(new nut_js_1.Image(image.cols, image.rows, image.getData(), image.channels, path, image.getData().length / (image.cols * image.rows), image.getData().length / image.rows / 8));
            }
            catch (e) {
